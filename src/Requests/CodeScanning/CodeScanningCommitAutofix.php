 ...
 *
 * If an autofix is committed as a result of this
 * request, then this endpoint will return a 201 Created response.
 *
 ...
 */
class CodeScanningCommitAutofix extends Request implements HasBody
{
    use HasJsonBody;
    ...
    {
        return "/repos/{$this->owner}/{$this->repo}/code-scanning/alerts/{$this->alertNumber}/autofix/commits";
    }
