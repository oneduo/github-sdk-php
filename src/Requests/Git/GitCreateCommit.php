 ...
 * Type | Description |
 * | ---- | ---- | ----------- |
 * | `verified` | `boolean` | Indicates whether
 * GitHub considers the signature in this commit to be verified. |
 * | `reason` | `string` | The reason
 * for verified value. Possible values and their meanings are enumerated in the table below. |
 * |
 ...
 */
class GitCreateCommit extends Request implements HasBody {
    use HasJsonBody;

    protected Method $method = Method::POST;

    public function resolveEndpoint(): string {
        return "/repos/{$this->owner}/{$this->repo}/git/commits";
    }
