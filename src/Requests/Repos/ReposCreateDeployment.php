 ...
 *
 * You will see this response when GitHub automatically merges the
 * base branch into the topic branch instead of creating
 ...
 * (classic) need the `repo` or `repo_deployment` scope to use this endpoint.
 */
