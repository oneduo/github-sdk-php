...
class ApiInsightsGetUserStats extends Request
{
     ...
     * @param  null|string  $actorNameSubstring  Providing a substring will filter results where the actor name contains the substring. This is a case-insensitive search.
     */
    ...
    public function defaultQuery(): array
    {
        return array_filter([
            ...
            'sort' => $this->sort,
            'actor_name_substring' => $this->actorNameSubstring,
        ]);
    }
}
