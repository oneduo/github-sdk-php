 ...
 * return results for a given day if the organization contained **five or more members with active
 * Copilot licenses** on that day, as evaluated at the end of that day.
 *
 * The response contains metrics
 * for up to 28 days prior. Metrics are processed once per day for the previous day,
 * and the response
 * will only include data up until yesterday. In order for an end user to be counted towards these
 * metrics,
 * they must have telemetry enabled in their IDE.
 *
 * To access this endpoint, the Copilot
 * Metrics API access policy must be enabled for the organization.
 * Only organization owners and owners
 * and billing managers of the parent enterprise can view Copilot metrics.
 *
