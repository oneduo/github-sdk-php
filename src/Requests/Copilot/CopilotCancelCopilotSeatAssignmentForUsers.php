 ...
 *
 * Sets seats for all users
 * specified to "pending cancellation".
 * This will cause the specified users to lose access to GitHub
 * Copilot at the end of the current billing cycle unless they retain access through team
 * membership.
 * For more information about disabling access to Copilot, see "[Revoking access to Copilot
 * for members of your
 ...
 * endpoint.
 */
class CopilotCancelCopilotSeatAssignmentForUsers extends Request {
