 ...
 * on the organization's Copilot plan. For more information about Copilot pricing, see "[About billing
 * for GitHub Copilot in your
 ...
 */
class CopilotAddCopilotSeatsForTeams extends Request implements HasBody {
    use HasJsonBody;
