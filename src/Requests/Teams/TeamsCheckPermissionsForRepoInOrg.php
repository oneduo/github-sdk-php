 ...
 *
 * If a team doesn't have
 * permission for the repository, you will receive a `404 Not Found` response status.
 *
 * If the
 * repository is private, you must have at least `read` permission for that repository, and your token
 * must have the `repo` or `admin:org` scope. Otherwise, you will receive a `404 Not Found` response
 * status.
 *
 * > [!NOTE]
