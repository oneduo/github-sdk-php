 ...
 * removed from the Teams API. We recommend migrating your existing code to use the new [Add or update
 ...
 * > [!NOTE]
 * > When you have
 * team synchronization set up for a team with your organization's identity provider (IdP), you will
 * see an error if you attempt to use the API for making changes to the team's membership. If you have
 * access to manage group membership in your IdP, you can manage GitHub team membership through your
 * identity provider, which automatically adds and removes team members in an organization. For more
