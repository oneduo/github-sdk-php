 ...
 *
 * > [!NOTE]
 * > You can also specify a team or organization with `team_id` and `org_id` using the route
 * `DELETE
 ...
 * endpoint.
 */
class ReactionsDeleteForTeamDiscussionComment extends Request {
    protected Method $method = Method::DELETE;

    public function resolveEndpoint(): string {
        return "/orgs/{$this->org}/teams/{$this->teamSlug}/discussions/{$this->discussionNumber}/comments/{$this->commentNumber}/reactions/{$this->reactionId}";
    }
